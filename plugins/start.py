...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("¯_( ͡° ͜ʖ ͡°)_/¯ 𝙊𝙒𝙉𝙀𝙍 ¯_( ͡° ͜ʖ ͡°)_/¯", url="https://t.me/NAZZY_FF")
                ],
                [
                    InlineKeyboardButton("💥 𝙂𝙍𝙊𝙐𝙋", url="https://t.me/nazzymoviez"),
                    InlineKeyboardButton("𝘾𝙃𝘼𝙉𝙉𝙀𝙇 💥", url="https://t.me/nazzymovies2")
                ]
            ]
        )
